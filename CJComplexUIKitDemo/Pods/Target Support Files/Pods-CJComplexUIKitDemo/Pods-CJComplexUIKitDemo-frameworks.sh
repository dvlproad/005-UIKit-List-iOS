...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJCollectionViewLayout-Swift/CJCollectionViewLayout_Swift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJFeatureListKit-Swift/CJFeatureListKit_Swift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJListDemo-Swift/CJListDemo_Swift.framework"
