...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../CJComplexUIKit/CJDataScrollView/ImagePickerCollectionlView/Resources/cjCollectionViewCellAdd@2x.png"
  install_resource "${PODS_ROOT}/../../CJComplexUIKit/CJDataScrollView/ImagePickerCollectionlView/Resources/cjCollectionViewCellDelete@2x.png"
